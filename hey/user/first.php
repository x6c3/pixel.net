...
<body>
    <header>
        <a class="logo" href="first.php">Pixel</a>
        <nav class="navigation">
            <a href="about.html" class="link">About</a>
            <a href="review_first.php" class="link">Reviews</a>
            <?php if (isset($_COOKIE['email'])) {
                echo '<a href="info.php" class="link">Your Username</a>';
            } else {
                echo '<a href="login.html"><button class="link">Login</button></a>';
            }
            ?>
        </nav>
    </header>
    ...
    <nav class="navig">
        ...
        <div class="button-container">
            <button onclick="goToFullWebsite()" style="cursor: pointer;">
